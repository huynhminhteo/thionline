																								...
																								<tr>
																									<td>
																										<table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>この度はHOVITをご利用いただきありがとうございます。</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            </tr>
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    ご利用分の入金確認が取れませんでしたのでお知らせします。<br/>
                                                                                                                    ーーーーーーーーーーーーーーーーーー<br/>
                                                                                                                    契約プラン：{{$plan_name}}<br/>
                                                                                                                    ご利用期間：{{$plan_date}}<br/>
                                                                                                                    お支払方法：クレジットカード支払<br/>
                                                                                                                    決済予定日：{{$transaction_date}}<br/>
                                                                                                                    ーーーーーーーーーーーーーーーーーー<br/>
                                                                                                                    ＊決済予定日は決済代行会社との関係上、実際の決済予定日とは異なる場合がございます。<br/>
                                                                                                                    ご了承ください。<br/>
                                                                                                                    ＊未入金となっているためサービス利用を一部制限しております。<br/>
                                                                                                                    HOVIT管理システムにログインの上、メニュー→プラン設定よりクレジットカードを<br/>
                                                                                                                    変更されるか、クレジットカード会社までお問い合わせの上、決済手続きをお願いします。
																												</td>
																											</tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>お支払いに関するお問い合わせは下記HOVIT運営事務局までお問い合わせください。</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            </tr>
