			...
			<tr>
				<td>
					<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff"
						style="font-family:Yu Gothic, helvetica, sans-serif;" class="MainContainer">
						<!-- =============== START HEADER =============== -->
						<tbody>
							<tr>
								<td>
																								...
																								<tr>
																									<td>
																										<table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>この度は「HOVIT」をご契約いただき誠にありがとうございます。</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td>「HOVIT」をご利用いただく各種情報をご案内いたします。</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            </tr>
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    管理システムURL：<a href="{{config('constant.admin_url')}}">{{config('constant.admin_url')}}</a><br/>
                                                                                                                    事業所ID：{{$corp_id}}<br/>
                                                                                                                    Login ID：{{$mail}}<br/>
                                                                                                                    Password：{{$password}}<br/>
                                                                                                                    ＊Passwordについてはセキュリティの関係上、ログイン後メニューにあるパスワード変更より<br/>
                                                                                                                    　パスワード変更をお願いします。
																												</td>
																											</tr>
                                                                                                            <tr>
																											...
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    HOVITスマートフォンアプリは下記よりダウンロードできます。<br/>
                                                                                                                    iOS:<a href="#">xxxxxxx</a>
                                                                                                                    Android:<a href="#">xxxxxx</a>
																												</td>
																											</tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
																											...
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    是非、ご活用ください。<br/>
                                                                                                                    ＊システムに関する各種マニュアル類については、管理システムにログイン後<br/>
                                                                                                                    上部メニューの「マニュアル」からダウンロードできます。
																												</td>
																											</tr>
																										</table>
																									</td>
																	...
																	<div class="movableContent"
																		...
																		<table width="100%" border="0" cellspacing="0" cellpadding="0">
																			<tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="line-height: 16px;">
                                                                                        各種お問い合わせについては下記までお問い合わせください。<br/>
                                                                                        ーーーーーーーーーーーーーー<br/>
                                                                                        HOVIT運営事務局<br/>
                                                                                        mail:<a href="mailto:info@med-hovit.com">info@med-hovit.com</a><br/>
                                                                                        ーーーーーーーーーーーーーー
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
