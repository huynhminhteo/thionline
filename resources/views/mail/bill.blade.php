																													...
																													<td valign="middle" style='vertical-align: middle; padding-top: 5px;'>
																														<div class='contentEditableContainer contentTextEditable'>
																															<div class='contentEditable contentEditableDate'>
																																...
																																No.{{$year}}{{$month}}{{$day}}-S-{{$company->corp_id}}
																															</div>
																														</div>
																													</td>
																												</tr>
																												...
																												<td>
																													<div class='contentEditableContainer contentTextEditable'>
																														<div class='contentEditable' style='text-align: center;'>
																															<h2 style="font-size: 18px;"><b>請求書</b></h2>
																														</div>
																													</div>
																												</td>
																											</tr>
																									...
																									<td class="specbundle">
																										<div class='contentEditableContainer contentTextEditable'>
																											<div class='contentEditable' style='text-align: left; font-size: 8px;'>
                                                                                                                <h2 style="font-size: 10px; margin-bottom: 20px;">
                                                                                                                いつもHOVITをご利用いただき、ありがとうございます。<br/>
                                                                                                                ご利用のプランのご請求をさせていただきます。<br/>
                                                                                                                お支払いについては、クレジットカードによる自動引き落としとなります。<br/>
                                                                                                                なお、ご契約は自動更新となっておりますので、継続をご希望されない場合は<br/>
                                                                                                                必ず管理システムから解約手続きをお支払い期日までに行ってください。<br/>
                                                                                                                ※本サービスは前払い制となっております。
                                                                                                                </h2>
																												<table width="100%" border="0" cellspacing="0" cellpadding="0"
																													align="center">
																						...
																						<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 10px;">
																							<tbody>
																								...
																								<tr>
																									...
																									<td align="center" style="border-top: 1px solid #d7d7d7; padding: 5px;" class="specbundle specbundle-period"><span>{{$contract->contract_year}}年{{\Carbon\Carbon::parse($date_contract)->format('m')}}月{{\Carbon\Carbon::parse($date_contract)->startOfMonth()->format('d')}}日〜{{$contract->contract_year}}年{{\Carbon\Carbon::parse($date_contract)->format('m')}}月{{\Carbon\Carbon::parse($date_contract)->endOfMonth()->format('d')}}日</td></span>
