																								...
																								<tr>
																									<td>
																										<table width="100%" border="0" cellspacing="0" cellpadding="0"
																											...
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    【HOVIT】の管理ユーザー登録が完了しました。<br/>
                                                                                                                    下記リンクよりHOVIT管理システムにログインしてください。
																												</td>
																											</tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>HOVIT管理システム: <a href="{{config('constant.admin_url')}}">{{config('constant.admin_url')}}</a></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            </tr>
