																										...
																										<table width="100%" border="0" cellspacing="0" cellpadding="0"
																											...
																											<tr>
																												<td style="line-height: 16px;">
																													HOVIT運営システム<br/>
                                                                                                                    管理者　{{$operator_user_current_name}}です。
																												</td>
																											</tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
																											...
																											<tr>
																												<td style="line-height: 16px;">
																													【HOVIT】の運営ユーザー登録が完了しました。<br/>
                                                                                                                    下記リンクよりHOVIT運営システムにログインしてください。
																												</td>
																											</tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>HOVIT運営システム: <a href="{{route('admin.page.index')}}">{{route('admin.page.index')}}</a></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
                                                                                                            </tr>
																											<tr>
                                                                                                                ...
                                                                                                                ＊Passwordについてはセキュリティの関係上、ログイン後画面右上にあるアカウント情報をクリックすると表示されるパスワード変更よりパスワードの変更をお願いします。
																												</td>
																											</tr>
																										</table>
																									</td>
