																										...
																										<table width="100%" border="0" cellspacing="0" cellpadding="0"
																											...
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    この度はHOVITをご利用いただきありがとうございます。<br/>
                                                                                                                    解約のお申し込み受領いたしました。
																												</td>
																											</tr>
                                                                                                            <tr>
																											...
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    お支払いいただいている月額料金は前払い制のため、月末までご利用いただけます。<br/>
                                                                                                                    月末を過ぎるとアカウントが停止され管理システムへのログイン、アプリへのログインができなくなります。
																												</td>
																											</tr>
                                                                                                            <tr>
                                                                                                                <td height="10"></td>
																											...
																											<tr>
																												<td style="line-height: 16px;">
                                                                                                                    解約に関するお問い合わせについては下記までお問い合わせください。<br/>
                                                                                                                    ーーーーーーーーーーーーーー<br/>
                                                                                                                    HOVIT運営事務局<br/>
